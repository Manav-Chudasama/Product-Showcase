    ...
    <div className="mt-24 py-10 px-2 flex flex-col w-full gap-28 bg-gray-100">
      <div className="flex w-[90%] md:w-[80%] mx-auto">
        <h1 className="text-2xl md:text-4xl text-justify">
          Discover unbeatable offers on the finest handcrafted items and unique
          treasures, crafted to meet your{" "}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 w-full">
        <div className="flex flex-col items-center pb-5 rounded-xl shadow-[0_4px_8px_0_rgba(0,0,0,0.2)] transition-all hover:shadow-[0_8px_14px_0_rgba(0,0,0,0.2)]">
          <img className="h-14 sm:h-20 md:h-24 my-4" src={clothing} alt="" />
          <h1 className="font-bold text-2xl ">Clolthing</h1>
          <p className="text-center text-sm md:text-xl">Stylish and trendy</p>
        </div>
        <div className="flex flex-col items-center pb-5 rounded-xl shadow-[0_4px_8px_0_rgba(0,0,0,0.2)] transition-all hover:shadow-[0_8px_14px_0_rgba(0,0,0,0.2)]">
          <img className="h-14 sm:h-20 md:h-24 my-4" src={electronics} alt="" />
        ...
        <div className="flex flex-col items-center pb-5 rounded-xl shadow-[0_4px_8px_0_rgba(0,0,0,0.2)] transition-all hover:shadow-[0_8px_14px_0_rgba(0,0,0,0.2)]">
          <img className="h-14 sm:h-20 md:h-24 my-4" src={footwear} alt="" />
